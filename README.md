...
- [**Flat File CMS**](https://github.com/ahadb/flat-file-cms) — A collection of flat-file CMS systems  
- [**ES6**](https://github.com/ahadb/es6) — ES6 concepts, tools, and syntax  
- [**Log Analyzer**](https://github.com/ahadb/log-analyzer) — REST API for parsing and analyzing server logs  
- [**Ode to IIFE**](https://github.com/ahadb/iife) — A pattern that shaped JavaScript history  
